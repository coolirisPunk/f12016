...
class Event(TimeStampModel):
    ...
    slug_notification = AutoSlugField(unique_with=['description', 'event_type__event_day__description','start_time'], populate_from='description', null=True, max_length=160)
    class Meta:
        ordering = ['ordering']
